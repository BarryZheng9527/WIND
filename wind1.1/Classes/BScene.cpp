...
void BScene::loadstartAnimation(float dt) {
	...
	CCSpriteFrameCache::sharedSpriteFrameCache()->addSpriteFramesWithFile("armature/ThunderAnimation0.plist","armature/ThunderAnimation0.png");
	CCSpriteFrameCache::sharedSpriteFrameCache()->addSpriteFramesWithFile("armature/ThunderAnimation1.plist","armature/ThunderAnimation1.png");
	CCSpriteFrameCache::sharedSpriteFrameCache()->addSpriteFramesWithFile("armature/ThunderAnimation2.plist","armature/ThunderAnimation2.png");
